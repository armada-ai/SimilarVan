...
class TrajectoryDataset(data.Dataset):
    ...
    def coll_fn(self, scenario_list):
        ...
        print("dataset translation: ", self.translation)
        print("rotation: ", self.rotation)
        print("scale: ", self.scaling)
        print("obs_len: ", self.obs_len)
        print("max_neis: ", self.max_neis_num)
        print("dist_thresh: ", self.dist_threshold)
        print("smooth: ", self.smooth)
        print("scenario_list: ", scenario_list)
        print("scenario[0]: ", len(self.scenario_list), self.scenario_list[0])
        # print("", self.scenario_list[0][1].shape, self.scenario_list[0][2].shape)
        print("\n")
