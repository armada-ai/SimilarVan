...
# __C.RESULTS_BASE_PATH = "D:/Experiments/画图"

# ------------------------------------------------------------------------ #
# Testing options
# ------------------------------------------------------------------------ #
__C.TEST = CN()
__C.TEST.TRACKER_DIR = "./results"
...
__C.TRAIN.TOPK.USE_TOPK_REG = False
__C.TRAIN.TOPK.TOPK_NUM_REG = 35
__C.TRAIN.TOPK.WEIGHT_REG = 0.5
...
# __C.DATASET.NAMES = ('DET', )
base_path = "F:/dataset/crop_datas"
...
__C.DEBUG.FINAL_HEATMAP.SHOW_REG = False
