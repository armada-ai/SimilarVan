...
Usage: --img 640 --cfg yolov5m.yaml
    $ python path/to/export.py --weights yolov5s.pt --include torchscript onnx openvino engine coreml tflite ...
    $ python export.py --data coco134.yaml --weights ./runs/train/exp28/weights/best.pt --include torchscript onnx openvino engine coreml tflite ...
    $ python export.py --data 34.yaml --weights ./runs/train/exp9/weights/best.pt --include torchscript onnx openvino engine coreml tflite ...
    $ python export.py --data 1360.yaml --weights ./runs/train/exp8/weights/best.pt --include torchscript onnx openvino engine coreml tflite ...
    $ python export.py --data xiaoti.yaml --weights ./runs/train/exp22/weights/best.pt --include torchscript onnx openvino engine coreml tflite ...
